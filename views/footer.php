<footer class="footer d-flex flex-wrap flex-column justify-content-center align-content-center py-2 flex-lg-row justify-content-lg-between">
  ...
  <div class="dev-signature d-flex justify-content-center align-items-center me-xl-4">
    <p class="dev-signing mb-0 text-center">Developed by <a class="dev-link" href="https://github.com/MartinXCVI/" target="_blank">MartinXCVI</a></p>
  </div>
</footer>